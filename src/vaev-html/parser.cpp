...
export module Vaev.Html:parser;
...
#undef SPECIAL
    ...
    void _handleBeforeHead(HtmlToken& t) {
        ...
        // Anything else
            ...
            headToken.name = Symbol::from("head");
    ...
    void _handleAfterHead(HtmlToken& t) {
        auto anythingElse = [&] {
            ...
            bodyToken.name = Symbol::from("body");
    ...
    void _handleInTable(HtmlToken& t) {
        ...
        // A start tag whose tag name is "col"
            ...
            colGroupToken.name = Symbol::from("colgroup");
        ...
        // A start tag whose tag name is one of: "td", "th", "tr"
            ...
            tableBodyToken.name = Symbol::from("tbody"s);
        ...
        // A start tag whose tag name is "form"
            ...
            formToken.name = Symbol::from("form"s);
    ...
    void _handleInTableBody(HtmlToken& t) {
        ...
        // A start tag whose tag name is one of: "th", "td"
            ...
            tableRowToken.name = Symbol::from("tr"s);
