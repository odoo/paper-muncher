...
using FirstLine = Keyword<"first-line">;
static constexpr inline FirstLine FIRST_LINE{};

using LastLine = Keyword<"last-line">;
static constexpr inline LastLine LAST_LINE{};
