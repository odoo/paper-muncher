...
struct Computed {
    ...
    Cow<Margin> margin = makeCow<Margin>(Width(CalcValue<PercentOr<Length>>(Length(0_au))));
    Cow<Outline> outline;
    Cow<Padding> padding = makeCow<Padding>(Length(0_au));
    BoxSizing boxSizing;
    ...
    Position position;
    Cow<Offsets> offsets = makeCow<Offsets>(Width(CalcValue<PercentOr<Length>>(Length(0_au))));
