...
export Symbol NAMESPACE = Symbol::from("http://www.w3.org/1999/xhtml");
...
export Symbol NAMESPACE = Symbol::from("http://www.w3.org/2000/svg");
...
export Symbol NAMESPACE = Symbol::from("http://www.w3.org/1998/Math/MathML");
