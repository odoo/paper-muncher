/* Vendored from /include/uapi/linux/landlock.h @ v7.1.8 */
/* https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/include/uapi/linux/landlock.h?h=v7.1 */
