...
union Trans2 {
    ...
    static constexpr T const ZERO = T{};
    static constexpr T const ONE = T{1};
...
template <typename T>
Trans2<T> const IDENTITY = {
    Trans2<T>::ONE, Trans2<T>::ZERO,
    Trans2<T>::ZERO, Trans2<T>::ONE,
    Trans2<T>::ZERO, Trans2<T>::ZERO
};
