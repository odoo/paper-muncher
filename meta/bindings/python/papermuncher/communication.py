...
class Message:
    ...
    def _read_single_chunk(self, reader: io.TextIOWrapper) -> bytes:
    ...
    def readChunkedBody(self, reader: io.TextIOWrapper) -> bytes:
        encoded_body = b""
        while True:
            chunk = self._read_single_chunk(reader)
...
class Request(Message):
    def __init__(self, method=None, path=None, version=None, reader=None):
        super().__init__()
        self.method = method
        self.path = path
