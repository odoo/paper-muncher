...
SERVER_SOFTWARE = b'Paper Muncher (Fully Synchronous Engine)'
...
def rendered(
    ...
    **options,
    ...
    :param runner: Optional runner function to handle asset requests.
